...
public class EmployeeController {
    ...
    @PostMapping(value = "/saveEmployee")  //api/v1/employee/saveEmployee
    ...
    @PutMapping(value = "/updateEmployee")  //api/v1/employee/updateEmployee
    ...
    @GetMapping("/getEmployee/{empID}")  //api/v1/employee/getEmployee/{empID}
